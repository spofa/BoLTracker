				...
				@for($i = 0; $i < count($scripts); $i++)
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#{{{ $scripts[$i]->script_name }}}" class="collapsed"> <i class="fa fa-lg fa-angle-down pull-right"></i> <i class="fa fa-lg fa-angle-up pull-right"></i>{{{ $scripts[$i]->script_name }}}</a></h4>
						</div>
